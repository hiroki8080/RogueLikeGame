...
(function() {
  var App, Character, Chip, Combat, Dungeon, Key, MapGenerator, Point, Room, RoomUtils, SquareRoad, getTipWithCoordinates, init, options, plyer1,
  ...
  Dungeon = (function() {
    ...
    Dungeon.prototype.init = function() {
      var j, k, mapGenerator, ref, ref1, results, results1, widthArray;
      widthArray = (function() {
        results = [];
        for (var j = 1, ref = this.size; 1 <= ref ? j <= ref : j >= ref; 1 <= ref ? j++ : j--){ results.push(j); }
        return results;
