...
(function() {
  var App, Character, Combat, Dungeon, dungeon, getTipWithCoordinates, global, init, options, plyer1,
  ...
  App = (function() {
    var canvasInit, printEnemy, printPlayer, printRoad;
      ...
      for (x = j = 0, len = mapData.length; j < len; x = ++j) {
        ...
        results.push((function() {
          ...
          for (y = k = 0, len1 = row.length; k < len1; y = ++k) {
            ...
            switch (data) {
              case 2:
                results1.push(this.printWall(x, y, this.ctx));
                break;
              default:
                results1.push(this.printWall(x, y, this.ctx));
            }
    ...
    App.prototype.printWall = function(x, y, ctx) {
      console.log('print wall');
      return ctx.strokeText('2', x * 10, y * 10);
    };

    printRoad = function(x, y, ctx) {};

    printPlayer = function(x, y, ctx) {};

    printEnemy = function(x, y, ctx) {};
